            ...
            WorkManager.getInstance().getWorkInfoByIdLiveData(oneTimeWorkRequest.getId())
                    .observe(this, new Observer<WorkInfo>() {
                        ...
                        public void onChanged(@Nullable WorkInfo workInfo) {
                            ...
                            Toast.makeText(MainActivity.this, "STATE : "+workInfo.toString(), Toast.LENGTH_SHORT).show();
                            Log.d(TAB,"STATE : "+workInfo.toString());
                            mTextView.setText("STATE : "+workInfo.toString());
                            ...
                            if (workInfo != null) {
                                Toast.makeText(MainActivity.this, "oneTimeWorkRequest: " +
                                        ...
                                        .show();
                                mTextView.setText("One TimeWork Request: : "+workInfo.toString());
                            }
